...
import gui.model.Model.Perspective;
import gui.model.ModelAnonymizationConfiguration;
import gui.model.ModelAuditTrailEntry;
import gui.model.ModelCriterion;
import gui.model.ModelEvent;
import gui.model.ModelEvent.ModelPart;
import gui.model.ModelExplicitCriterion;
import gui.resources.Charsets;
import gui.resources.Resources;
import gui.view.SWTUtil;
import gui.view.def.IValidator;
import gui.view.def.IView;
import gui.view.impl.common.ComponentTitledFolder;
import gui.view.impl.define.LayoutDefinition;
import gui.view.impl.explore.LayoutExplore;
import gui.view.impl.menu.DialogAbout;
import gui.view.impl.menu.DialogAnonymization;
import gui.view.impl.menu.DialogAuditTrail;
import gui.view.impl.menu.DialogClassificationConfiguration;
import gui.view.impl.menu.DialogComboDoubleSelection;
import gui.view.impl.menu.DialogComboSelection;
import gui.view.impl.menu.DialogCriterionSelection;
import gui.view.impl.menu.DialogCriterionUpdate;
import gui.view.impl.menu.DialogDebug;
import gui.view.impl.menu.DialogError;
import gui.view.impl.menu.DialogFindReplace;
import gui.view.impl.menu.DialogHelp;
import gui.view.impl.menu.DialogMultiSelection;
import gui.view.impl.menu.DialogOrderSelection;
import gui.view.impl.menu.DialogQuery;
import gui.view.impl.menu.DialogQueryResult;
import gui.view.impl.menu.DialogTopBottomCoding;
import gui.view.impl.risk.LayoutRisks;
import gui.view.impl.utility.LayoutUtility;
import gui.worker.Worker;
