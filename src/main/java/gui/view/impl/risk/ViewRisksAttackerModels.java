 ...
 */
package gui.view.impl.risk;

import gui.Controller;
import gui.model.Model;
import gui.model.ModelEvent;
import gui.model.ModelEvent.ModelPart;
import gui.model.ModelRisk.ViewRiskType;
import gui.resources.Resources;
import gui.view.SWTUtil;
import gui.view.impl.common.ComponentRiskMonitor;
import gui.view.impl.common.ComponentRiskThresholds;
import gui.view.impl.common.ComponentStatusLabelProgressProvider;
import gui.view.impl.common.ComponentTitledSeparator;
import gui.view.impl.common.DelayedChangeListener;
import gui.view.impl.common.async.Analysis;
import gui.view.impl.common.async.AnalysisContext;
import gui.view.impl.common.async.AnalysisManager;
        ...
        if (isInput()) {
            ...
            riskThresholds.addSelectionListenerThresholdHighestRisk(new SelectionAdapter() {
                ...
                public void widgetSelected(SelectionEvent arg0) {
                    if (riskThresholds.getThresholdHighestRisk() != getModel().getRiskModel()
            ...
            riskThresholds.addSelectionListenerThresholdRecordsAtRisk(new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent arg0) {
                    if (riskThresholds.getThresholdRecordsAtRisk() != getModel().getRiskModel()
                            .getRiskThresholdRecordsAtRisk()) {
                        getModel().getRiskModel()
                                .setRiskThresholdRecordsAtRisk(riskThresholds.getThresholdRecordsAtRisk());
                        controller.update(new ModelEvent(this, ModelPart.RISK_THRESHOLD_DERIVED, null));
                        handleThresholdUpdateInMonitors();
                    }
                }
            ...
            riskThresholds.addSelectionListenerThresholdSuccessRate(new SelectionAdapter() {
                @Override
                public void widgetSelected(SelectionEvent arg0) {
                    if (riskThresholds.getThresholdSuccessRate() != getModel().getRiskModel()
        ...
        Analysis analysis = new Analysis() {
            ...
            public void run() throws InterruptedException {
                ...
                RiskModelSampleSummary summary = builder
                        .getSampleBasedRiskSummary(model.getRiskModel().getRiskThresholdHighestRisk());
